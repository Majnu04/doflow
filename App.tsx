...
const App: React.FC = () => {
    ...
    // Keep the client-side user in sync with the DB.
    // Example: if you promote a user from "student" -> "admin" directly in Mongo,
    // fetching /api/auth/me will update localStorage + Redux and the UI will reflect it.
    useEffect(() => {
    ...
    const hideNavbar = normalizedRoute.includes('/learn/') || normalizedRoute.includes('/dsa/problem/');
    const hideFooter = normalizedRoute.includes('/learn/') || normalizedRoute.includes('/dsa/problem/');
