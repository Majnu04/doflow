...
export const sendPasswordResetOTP = async (email, name, otp) => {
  ...
  const mailOptions = {
    from: `"${process.env.EMAIL_FROM_NAME || 'DoFlow'}" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: 'Password Reset OTP - DoFlow',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <style>
          ...
          .header {
            background: linear-gradient(135deg, #e46639 0%, #f08b4f 100%);
            padding: 30px;
            text-align: center;
            color: white;
          }
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p style="margin: 0 0 10px 0;">© ${new Date().getFullYear()} DoFlow. All rights reserved.</p>
            <p style="margin: 0;">Need help? Contact us at <a href="mailto:support@doflow.com" style="color: #e46639;">support@doflow.com</a></p>
          </div>
        </div>
      </body>
      </html>
...
export const sendRegistrationOTP = async (email, name, otp) => {
  ...
  const mailOptions = {
    from: `"${process.env.EMAIL_FROM_NAME || 'DoFlow'}" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: 'Your Registration OTP - DoFlow',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2 style="color: #333; margin-bottom: 20px;">Hi ${name}! 👋</h2>
            <p>Thank you for signing up with DoFlow! To complete your registration, please use the OTP code below:</p>
            ...
            <div class="warning">
              <strong>Security Notice:</strong> Never share this OTP with anyone. DoFlow staff will never ask for your OTP.
            </div>
...
export const sendVerificationEmail = async (email, name, verificationToken) => {
  ...
  const mailOptions = {
    from: `"${process.env.EMAIL_FROM_NAME || 'DoFlow'}" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: 'Verify Your Email - DoFlow',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Welcome, ${name}! 👋</h2>
            <p>Thank you for signing up with DoFlow. We're excited to have you on board!</p>
            ...
            <p>If you didn't create an account with DoFlow, please ignore this email.</p>
            
            <p>Best regards,<br>The DoFlow Team</p>
          </div>
          <div class="footer">
            <p>&copy; ${new Date().getFullYear()} DoFlow. All rights reserved.</p>
            <p>You're receiving this email because you signed up for DoFlow.</p>
          </div>
        </div>
      </body>
      </html>
...
export const sendPasswordResetEmail = async (email, name, resetToken) => {
  ...
  const mailOptions = {
    from: `"${process.env.EMAIL_FROM_NAME || 'DoFlow'}" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: 'Password Reset Request - DoFlow',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hello, ${name}</h2>
            <p>We received a request to reset your password for your DoFlow account.</p>
            ...
            <p>If you're having trouble, contact our support team at support@doflow.com</p>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Need help? Our support team is here for you 24/7 at support@doflow.com</p>
