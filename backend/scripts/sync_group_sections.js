...
// Section definitions: (title, [keywords to match lesson titles])
const sectionDefs = [
  ['Introduction', ['introduction', 'setup', 'first program', 'how to use']],
  ['Identifiers & Keywords', ['identifier', 'reserved word', 'keyword', 'comment', 'indentation']],
  ['Data Types & Type Casting', ['data type', 'type casting', 'fundamental', 'immutability', 'constants']],
  ['Operators', ['operator', 'precedence', 'arithmetic', 'comparison', 'logical', 'bitwise', 'assignment', 'identity', 'membership']],
  ['Input & Output', ['input', 'output', 'print', 'command line', 'dynamic input']],
...
(async () => {
  ...
  console.log('Grouped lessons into', sections.length, 'sections.');
})();
