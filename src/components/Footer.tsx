...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative mt-24 bg-light-cardAlt border-t border-border-subtle/80 overflow-hidden transition-colors duration-300">
        ...
        <div className="pt-10 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <a href="/#/" className="flex items-center gap-3 mb-6 group">
              ...
              />
              <span className="sr-only">DoFlow</span>
            </a>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-light-textSecondary hover:text-brand-primary transition-colors duration-300">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-display font-bold text-light-text mb-6 transition-colors duration-300">
              Quick Links
            </h3>
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-light-card hover:bg-brand-primary flex items-center justify-center text-light-textMuted hover:text-white transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
