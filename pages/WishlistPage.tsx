...
import { removeFromWishlist, clearWishlist, getWishlist } from '../src/store/slices/wishlistSlice';
...
const WishlistPage: React.FC = () => {
  ...
  const handleRemoveFromWishlist = (courseId: string) => {
    const promise = dispatch(removeFromWishlist(courseId)).unwrap();
  ...
  const handleAddToCart = async (course: any) => {
    ...
    if (isInCart) {
      ...
      const promise = dispatch(addToCart(course._id)).unwrap();
      toast.promise(promise, {
    ...
    toast(
      (t) => (
        <div className="text-center">
          <p className="font-semibold mb-3">Are you sure you want to clear your wishlist?</p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((course) => {
            ...
            return (
              <Card key={course._id} variant="subtle" className="group hover:scale-105 transition-all duration-300">
