...
import { removeFromCart, clearCart, getCart } from '../src/store/slices/cartSlice';
...
const CartPage: React.FC = () => {
  ...
  const handleRemoveFromCart = (courseId: string) => {
    const promise = dispatch(removeFromCart(courseId)).unwrap();
    ...
    toast(
      (t) => (
        <div className="text-center">
          <p className="font-semibold mb-3">Are you sure you want to clear your cart?</p>
    ...
    <div className="min-h-screen pt-24 pb-12 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          {items.map((course) => (
            <Card key={course._id} variant="glass" className="mb-4">
